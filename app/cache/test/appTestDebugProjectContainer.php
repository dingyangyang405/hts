...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'twig.data_extension' => 'getTwig_DataExtensionService',
            'twig.exception_listener' => 'getTwig_ExceptionListenerService',
            'twig.html_extension' => 'getTwig_HtmlExtensionService',
            'twig.loader' => 'getTwig_LoaderService',
            'twig.profile' => 'getTwig_ProfileService',
            'twig.translation.extractor' => 'getTwig_Translation_ExtractorService',
            'twig.web_extension' => 'getTwig_WebExtensionService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Hermes\WebBundle\Listener\CsrfTokenValidateListener A Hermes\WebBundle\Listener\CsrfTokenValidateListener instance
     */
    protected function getApp_CsrfTokenValidateListenerService()
    {
        return $this->services['app.csrf_token_validate_listener'] = new \Hermes\WebBundle\Listener\CsrfTokenValidateListener($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Hermes\WebBundle\Security\UserProvider A Hermes\WebBundle\Security\UserProvider instance
     */
    protected function getApp_UserProviderService()
    {
        return $this->services['app.user_provider'] = new \Hermes\WebBundle\Security\UserProvider($this->get('biz'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Hermes\Biz\BizKernel A Hermes\Biz\BizKernel instance
     */
    protected function getBizService()
    {
        return $this->services['biz'] = new \Hermes\Biz\BizKernel(array('database' => array('name' => 'hermes_test', 'user' => 'root', 'password' => 'root', 'host' => '127.0.0.1', 'port' => 3306, 'driver' => 'pdo_mysql', 'charset' => 'UTF8')), $this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'hermes_test', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Codeages\\Biz\\Framework\\Dao\\Connection', 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4ec3ad6b88688d455e0a507876fb4444cf474073a1512d82968793181298e2ed');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Hermes\\WebBundle\\Security\\CurrentUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha256', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/operator');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/workspace');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/ticket');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/faq');
        ...
        $o->add($h, array(0 => 'ROLE_SERVICE'), NULL);
        $o->add($i, array(0 => 'ROLE_SERVICE'), NULL);
        $o->add($j, array(0 => 'ROLE_DIRECTOR'), NULL);
        $o->add($k, array(0 => 'ROLE_DIRECTOR'), NULL);
        $o->add($l, array(0 => 'ROLE_DIRECTOR'), NULL);
        $o->add($k, array(0 => 'ROLE_DIRECTOR'), NULL);
        $o->add($m, array(0 => 'ROLE_DIRECTOR'), NULL);
        $o->add($n, array(0 => 'ROLE_ADMIN'), NULL);

        $p = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $q = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '53467db1b5cb9dfeca561bda7970f61a275be7b6', 'main', array('lifetime' => 8640000, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Hermes\WebBundle\Twig\Extension\HelperExtension($this));
        $instance->addExtension($this->get('twig.web_extension'));
        $instance->addExtension($this->get('twig.html_extension'));
        $instance->addExtension($this->get('twig.data_extension'));
    ...
    /**
     * Gets the 'twig.data_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Hermes\WebBundle\Twig\Extension\DataExtension A Hermes\WebBundle\Twig\Extension\DataExtension instance
     */
    protected function getTwig_DataExtensionService()
    {
        return $this->services['twig.data_extension'] = new \Hermes\WebBundle\Twig\Extension\DataExtension($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Hermes\WebBundle\Twig\Extension\HtmlExtension A Hermes\WebBundle\Twig\Extension\HtmlExtension instance
     */
    protected function getTwig_HtmlExtensionService()
    {
        return $this->services['twig.html_extension'] = new \Hermes\WebBundle\Twig\Extension\HtmlExtension();
    }
    ...
    /**
     * Gets the 'twig.web_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Hermes\WebBundle\Twig\Extension\WebExtension A Hermes\WebBundle\Twig\Extension\WebExtension instance
     */
    protected function getTwig_WebExtensionService()
    {
        return $this->services['twig.web_extension'] = new \Hermes\WebBundle\Twig\Extension\WebExtension($this);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('53467db1b5cb9dfeca561bda7970f61a275be7b6');
    }
    ...
    {
        return $this->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController($this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('profiler', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('twig'), array('data_collector.request' => array(0 => 'request', 1 => '@WebProfiler/Collector/request.html.twig'), 'data_collector.time' => array(0 => 'time', 1 => '@WebProfiler/Collector/time.html.twig'), 'data_collector.memory' => array(0 => 'memory', 1 => '@WebProfiler/Collector/memory.html.twig'), 'data_collector.ajax' => array(0 => 'ajax', 1 => '@WebProfiler/Collector/ajax.html.twig'), 'data_collector.form' => array(0 => 'form', 1 => '@WebProfiler/Collector/form.html.twig'), 'data_collector.exception' => array(0 => 'exception', 1 => '@WebProfiler/Collector/exception.html.twig'), 'data_collector.logger' => array(0 => 'logger', 1 => '@WebProfiler/Collector/logger.html.twig'), 'data_collector.events' => array(0 => 'events', 1 => '@WebProfiler/Collector/events.html.twig'), 'data_collector.router' => array(0 => 'router', 1 => '@WebProfiler/Collector/router.html.twig'), 'data_collector.twig' => array(0 => 'twig', 1 => '@WebProfiler/Collector/twig.html.twig'), 'data_collector.doctrine' => array(0 => 'db', 1 => '@Doctrine/Collector/db.html.twig'), 'swiftmailer.data_collector' => array(0 => 'swiftmailer', 1 => '@Swiftmailer/Collector/swiftmailer.html.twig'), 'data_collector.security' => array(0 => 'security', 1 => '@Security/Collector/security.html.twig'), 'data_collector.dump' => array(0 => 'dump', 1 => '@Debug/Profiler/dump.html.twig'), 'data_collector.config' => array(0 => 'config', 1 => '@WebProfiler/Collector/config.html.twig')), 'bottom');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('app.user_provider'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '53467db1b5cb9dfeca561bda7970f61a275be7b6', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57ba4ead833f55.22396536')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdminBundle' => 'Hermes\\AdminBundle\\AdminBundle',
                'WebBundle' => 'Hermes\\WebBundle\\WebBundle',
            ...
            'secret' => '53467db1b5cb9dfeca561bda7970f61a275be7b6',
            ...
            'locale' => 'en',
            'upload.public_directory' => ($this->targetDirs[2].'/../web/files'),
            ...
            'kernel.secret' => '53467db1b5cb9dfeca561bda7970f61a275be7b6',
