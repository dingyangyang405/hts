...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['biz'] = new \Hermes\Biz\BizKernel(array('database' => array('name' => 'hermes', 'user' => 'root', 'password' => 'root', 'host' => '127.0.0.1', 'port' => 3306, 'driver' => 'pdo_mysql', 'charset' => 'UTF8')), $this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'hermes', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Codeages\\Biz\\Framework\\Dao\\Connection', 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
