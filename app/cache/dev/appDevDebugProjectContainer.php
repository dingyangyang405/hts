...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['biz'] = new \Hermes\Biz\BizKernel(array('database' => array('name' => 'hermes', 'user' => 'root', 'password' => 'kz123', 'host' => '127.0.0.1', 'port' => 3306, 'driver' => 'pdo_mysql', 'charset' => 'UTF8')), $this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'hermes', 'user' => 'root', 'password' => 'kz123', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Codeages\\Biz\\Framework\\Dao\\Connection', 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ec7671dd97c7db9a73501731f0f9696e582aba562027ac712372002adeabbf98');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $q = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('lifetime' => 8640000, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
