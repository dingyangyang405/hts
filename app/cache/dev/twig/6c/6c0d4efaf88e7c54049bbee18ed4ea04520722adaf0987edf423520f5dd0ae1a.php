...
/* WebBundle:WorkSpace:ticket-delayed-wrapper.html.twig */
class __TwigTemplate_7839243ecc0f6dea731b7e67c9661b642320e031e14ac60924f7bc108ea99de8 extends Twig_Template
{
    ...
    {
        $__internal_28bfead5878aa29e201922cecf2ad8120d32faf732c50d914d105ce11813004c = $this->env->getExtension("native_profiler");
        $__internal_28bfead5878aa29e201922cecf2ad8120d32faf732c50d914d105ce11813004c->enter($__internal_28bfead5878aa29e201922cecf2ad8120d32faf732c50d914d105ce11813004c_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "WebBundle:WorkSpace:ticket-delayed-wrapper.html.twig"));
  ...
  <div class=\"row\">
    <div class=\"col-xs-12\">
      <div class=\"box\" style=\"border-top:0px;border-radius:0px;\">
        ...
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ticket_delayed_list", array("userId" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "operatorNo", array(), "array"))), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ticket"]) {
            // line 65
            echo "              <tr>
                <td><input type=\"checkbox\" name=\"checkboxId\" value=\"";
            // line 66
        ...
        $__internal_28bfead5878aa29e201922cecf2ad8120d32faf732c50d914d105ce11813004c->leave($__internal_28bfead5878aa29e201922cecf2ad8120d32faf732c50d914d105ce11813004c_prof);

    }

    public function getTemplateName()
    {
        return "WebBundle:WorkSpace:ticket-delayed-wrapper.html.twig";
    }
    ...
    {
        return array (  195 => 80,  191 => 78,  182 => 75,  178 => 74,  171 => 73,  165 => 71,  163 => 70,  156 => 68,  152 => 67,  148 => 66,  145 => 65,  141 => 64,  120 => 46,  115 => 44,  106 => 40,  100 => 39,  94 => 38,  85 => 32,  76 => 26,  69 => 21,  54 => 19,  50 => 18,  41 => 12,  36 => 10,  31 => 8,  22 => 1,);
    }
}
...
/*           <h3 class="box-title">滞留工单</h3>*/
/*         </div>*/
/*         <form class="form-inline well well-sm" action="{{path('ticket_delayed_list', {userId:user['operatorNo']})}}" method="get" novalidate="" style="border-radius:0px;">*/
/*           <div class="form-group" style="margin-bottom: 10px; ">*/
...
/*               <tr>*/
/*                 <td><input type="checkbox" name="checkboxId" value="{{ticket.id}}"></td>*/
...
/*                   {{ category.name }}*/
/*                 </td>*/
/*                 <td style="text-align:center;">{% set userInfo = data('User', {userId:ticket.userId}) %}{{ userInfo.username|default() }}<h5><small>{{ ticket.created|date('Y-m-d H:i:s') }}</small></h5></td>*/
